...
# The date in early October is a clear outlier with around 23. After that, New Years Day has another spike that is much higher than the dates around it. However, disregarding that, there seems to be a declining trend in number of calls from October 2022 to January 2023. 
...
# Tuesday, October 4 had a number of calls that was way above the average for a Tuesday. October 4, would fall above the 95th percentile for all Tuesdays recoreded in the data. 
...
# Based on the z-score data, we can see that in July, there was an uptick in calls in an eight day span in July. This likely indicates an anomoly that occured in July. In this case it was a bad batch of drugs that caused the increase in calls. I would talk to law enforcement and see if they tell me anything they know. Then I might go to people familiar with drugs in the area, (not necessarily drug addicts or dealers), maybe advocates who got clean, the DEA, or other experts. 
