...
#The range of weights goes from around .25 to just over 3. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
#A weight of .23 means that there are a lot more of this type of respondent so their response is weighted less. A higher weight means there is a lot less of that type of respondent so their response counts for more than just them. 

3. Why might some respondents be weighted more heavily than others?
# There may be a lot of a certain type of person who responded to the survey and much less of another kind of person. This may not represent the true population proportion so they are weighted to correct the representation. 
...
#The "rarely/never" people can change an election if they come out or not so knowing the most accurate figure can help determine who will win. 
...
# The "rarely/never" people are harder to reach, less likely to vote, and thus less likely to fill out surveys. 
